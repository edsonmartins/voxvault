...
export function TitleBar({ onSettingsClick, stealthMode }: TitleBarProps) {
  const handleClose = () => {
  ...
  return (
    <div className="titlebar" data-tauri-drag-region>
      <div className="titlebar-left">
        <span className="titlebar-title">VoxVault</span>
        {stealthMode && (
          <span className="stealth-badge" title="Invisible during screen sharing">
            STEALTH
          </span>
        )}
      </div>
